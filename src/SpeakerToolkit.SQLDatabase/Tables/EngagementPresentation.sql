...
(
  ...
  CONSTRAINT fkEngagementPresentation_EngagementStatus FOREIGN KEY (StatusId) REFERENCES dbo.EngagementStatus (EngagementStatusId)
)
GO
...
GO
EXEC sp_addextendedproperty @level0name=N'dbo', @level1name=N'EngagementPresentation', @level2name=N'StatusId',                                  @value=N'Identifier of the status for the engagement presentation.',                                                            @name=N'MS_Description', @level0type=N'SCHEMA', @level1type=N'TABLE', @level2type=N'COLUMN';
GO
...
GO
EXEC sp_addextendedproperty @level0name=N'dbo', @level1name=N'EngagementPresentation', @level2name=N'fkEngagementPresentation_EngagementStatus', @value=N'Defines the relationship between the EngagementPresentation and EngagementStatus tables using the StatusId column.',   @name=N'MS_Description', @level0type=N'SCHEMA', @level1type=N'TABLE', @level2type=N'CONSTRAINT';
GO