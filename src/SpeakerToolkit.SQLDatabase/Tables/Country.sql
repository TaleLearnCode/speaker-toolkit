...
GO
EXEC sp_addextendedproperty @level0Name=N'dbo', @level1name=N'Country', @level2Name=N'idxCountry_WorldSubregionCode', @value = N'Defines an index on the Country table using the WorldSubregionCode column.',                   @name=N'MS_Description', @level0type=N'SCHEMA', @level1type=N'TABLE', @level2type=N'INDEX';
GO